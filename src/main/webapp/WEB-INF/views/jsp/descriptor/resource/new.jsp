...
<div class="container">
        ...
        <form:form method="POST"
          action="/descriptor/resource" modelAttribute="descriptor">
            ...
            <div class="form-group">
                    <form:label path="value">string Value</form:label>
                    <form:input path="value" type="text" class="form-control" placeholder="resource.url"/>
            </div>
