...
<div class="container">
        ...
        <form:form method="POST"
          action="/descriptor/integer" modelAttribute="descriptor">
            ...
            <div class="form-group">
                    <form:label path="value">int Value</form:label>
                    <form:input path="value" type="text" class="form-control" placeholder="1234"/>
            </div>
